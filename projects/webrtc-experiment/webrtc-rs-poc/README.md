...
- `POC_PUBLISHER_ARGS` default:
  - `-f lavfi -i testsrc=size=640x360:rate=10 -an -c:v libx264 -preset ultrafast -tune zerolatency -pix_fmt yuv420p -f rtp rtp://127.0.0.1:5004`
